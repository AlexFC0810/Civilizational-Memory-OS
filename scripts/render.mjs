...
const BUNDLES = [
  ...
  { ids: ["CMOS-0010"], section: "University & Madrasa System", file: "university-madrasa-system.html" },
  { ids: ["CMOS-0011"], section: "Waqf Endowment Engine", file: "waqf-endowment-engine.html" },
];
